...
####TO EDIT
if res == 513:
    test_l2 = 0.008388#0.009214
    timestamp = '20220908-141820'#'20220724-112413'
    batch_size = 5
if res == 257:
    test_l2 = 0.008168
    timestamp = '20220724-000342'
if res == 129:
    test_l2 = 0.008025
    timestamp = '20220723-181703'
if res == 65:
    test_l2 = 0.009535
    timestamp = '0.009535'
if res == 33:
    test_l2 = 0.016297
    timestamp = '20220723-140115'
if res == 17:
    test_l2 = 0.031278
#####
 

ModelInfos = "_NL_%03d"%(res)+"~res_"+str(np.round(test_l2,6))+"~RelL2TestError_"+str(ntrain)+"~ntrain_"+str(ntest)+"~ntest_"+str(batch_size)+"~BatchSize_"+str(learning_rate)+\
...
fig.tight_layout()
plt.savefig('figures/eval/PINO-DarcyPWC-Forward-UP.png',dpi=500)
...
plt.imshow(F_train[0], cmap=colourMap, extent=[params["xmin"], params["xmax"], params["ymin"], params["ymax"]], origin='lower', aspect = 'auto')#, vmin=0, vmax=1, )
plt.colorbar()#format=OOMFormatter(-5))
plt.savefig('figures/eval/Input-DarcyPWC-Forward-UP.png',dpi=500)
...
plt.imshow(U_FDM, cmap=colourMap, extent=[params["xmin"], params["xmax"], params["ymin"], params["ymax"]], origin='lower', aspect = 'auto')#, vmin=0, vmax=1, )
plt.colorbar()#format=OOMFormatter(-5))
plt.savefig('figures/eval/GroundTruth-DarcyPWC-Forward-UP.png',dpi=500)
...
plt.imshow(F_train[0], cmap=colourMap, extent=[params["xmin"], params["xmax"], params["ymin"], params["ymax"]], origin='lower', aspect = 'auto')#, vmin=0, vmax=1, )
plt.colorbar()#format=OOMFormatter(-5))
plt.savefig('figures/eval/GroundTruth-DarcyPWC-Inverse-UP.png',dpi=500)
...
plt.imshow(U_FDM, cmap=colourMap, extent=[params["xmin"], params["xmax"], params["ymin"], params["ymax"]], origin='lower', aspect = 'auto')#, vmin=0, vmax=1, )
plt.colorbar()#format=OOMFormatter(-5))
plt.savefig('figures/eval/Input-DarcyPWC-Inverse-UP.png',dpi=500)
