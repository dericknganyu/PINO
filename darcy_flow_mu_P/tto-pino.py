...
################################################################
PATH = "aUP_Square_TrainData=1_TestData=1_Resolution=513X513_Domain=[0,1]X[0,1].hdf5"
#Read Datasets
...
if res == 513:
    test_l2 = 0.005897
    timestamp = '20220716-084321'
if res == 257:
    test_l2 = 0.005705
    timestamp = '20220715-203811'
if res == 129:
    test_l2 = 0.005371
    timestamp = '20220715-154525'
if res == 65:
    test_l2 = 0.006299
    timestamp = '20220715-145316'
if res == 33:
    test_l2 = 0.01165
    timestamp = '20220715-140427'
if res == 17:
    test_l2 = 0.024113
    timestamp = '20220715-152431'
...
fileName = "aUP_Square_TrainData=1_TestData=1_Resolution=513X513_Domain=[0,1]X[0,1].hdf5"
