...
####TO EDIT
if res == 513:
    test_l2 = 0.003103 #0.004359
    timestamp = '20220908-065711'#'20220716-185858'
    batch_size = 5
if res == 257:
    test_l2 = 0.003892
    timestamp = '20220716-074726'
if res == 129:
    test_l2 = 0.003811
    timestamp = '20220716-033230'
if res == 65:
    test_l2 = 0.004176
    timestamp = '20220716-021311'
if res == 33:
    test_l2 = 0.005957
    timestamp = '20220716-010712'
if res == 17:
    test_l2 = 0.017366
    timestamp = '20220716-014144'
#####


ModelInfos = "_NLC_%03d"%(res)+"~res_"+str(np.round(test_l2,6))+"~RelL2TestError_"+str(ntrain)+"~ntrain_"+str(ntest)+"~ntest_"+str(batch_size)+"~BatchSize_"+str(learning_rate)+\
...
for i in range(25):#(100): #Just a range in order to average the times for testing
...
fig.tight_layout()
plt.savefig('figures/eval/PINO-Poisson-Forward-UG.png',dpi=500)
...
plt.imshow(F_train[0], cmap=colourMap, extent=[params["xmin"], params["xmax"], params["ymin"], params["ymax"]], origin='lower', aspect = 'auto')#, vmin=0, vmax=1, )
plt.colorbar()#format=OOMFormatter(-5))
plt.savefig('figures/eval/Input-Poisson-Forward-UG.png',dpi=500)
...
plt.imshow(U_FDM, cmap=colourMap, extent=[params["xmin"], params["xmax"], params["ymin"], params["ymax"]], origin='lower', aspect = 'auto')#, vmin=0, vmax=1, )
plt.colorbar()#format=OOMFormatter(-5))
plt.savefig('figures/eval/GroundTruth-Poisson-Forward-UG.png',dpi=500)
...
plt.imshow(F_train[0], cmap=colourMap, extent=[params["xmin"], params["xmax"], params["ymin"], params["ymax"]], origin='lower', aspect = 'auto')#, vmin=0, vmax=1, )
plt.colorbar()#format=OOMFormatter(-5))
plt.savefig('figures/eval/GroundTruth-Poisson-Inverse-UG.png',dpi=500)
...
plt.imshow(U_FDM, cmap=colourMap, extent=[params["xmin"], params["xmax"], params["ymin"], params["ymax"]], origin='lower', aspect = 'auto')#, vmin=0, vmax=1, )
plt.colorbar()#format=OOMFormatter(-5))
plt.savefig('figures/eval/Input-Poisson-Inverse-UG.png',dpi=500)
